                ...
                <header>
                    <nav className="w-full flex-between  py-5 container">
                        ...
                        <div className="relative search-box rounded-xl flex items-center">
                            ...
                            <input placeholder="Search in Social..." type="text"
                        ...
                        <div className="flex gap-6 items-center">
                            ...
                            <div className="w-12 h-12 rounded-full overflow-hidden rounded-full">
                                <a href={`/page/${userData?._id}`} id="profileButton" className="w-full h-full bg-transparent border-none">
                                    <img src={userData?.profilePicture ? `${import.meta.env.VITE_BACKEND_URL}${userData.profilePicture}` : "/images/default-profile.jpg"} className="object-cover" alt="profile cover"/>
                                </a>
                            </div>
                            ...
                            <div className="post-upload-box">
                                ...
                                <div id="file-upload-box" className="mt-5">
                                    ...
                                    <div className="upload-file-txt">
                                        <p className="max-w-max max-h-max">
                                            Upload a file
                                        </p>
                                    </div>
                                    <p className="font-Poppins-Bold text-3xl text-white" id="browse-files">
                                        Browse file
                                    </p>

                                    <input type="file" name="media" id="file-upload-input" accept="video/*, image/*"/>
                                </div>
                            </div>
                            ...
                            <div className="post-upload-box">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full mt-4"></textarea>
                                </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <input type="text" name="hashtags" id="post-hashtags"
                                           placeholder="javascript, edit, trend, explore, ne..."/>
                                    <div id="hashtags-wrap" className="flex text-sm my-2 items-center gap-2">
                                    </div>
                                    <span
                                        className="text-sm font-Poppins-Light">Split the hashtags with comma ( , )</span>
                                </div>

                                {/*Upload Button*/}
                                <div className="mt-4 flex items-center justify-end">
                                    <button type="submit" id="upload-button" className="max-w-max">
                                        Upload post
                                    </button>
                                </div>
                            </div>
