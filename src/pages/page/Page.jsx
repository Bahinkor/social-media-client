          ...
          <section id="profile-content" className="profile-content">
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-3 text">
                      ...
                      <a href="https://google.com" className="url text-sm">
                        {" "}
                        google.com{" "}
                      </a>
                    </div>
                    <div className="flex items center gap-4 mt-4">
                      ...
                      >
                        ...
                        <span className="text-gray-700 followers">
                          Followers
                        </span>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <span className="text-gray-700 followings">
                          Followings
                        </span>
                      </div>
                    </div>
            ...
            <div id="profile-feeds">
              <header id="buttons-container" className="flex items-center">
                <button className="profile-feed__button isActive">Posts</button>
          ...
          <aside className="profile-sidebar">
            <section className="profile-side-card shadow">
              <header className="flex justify-between">
                <h5 className="side-title" style={{ fontSize: "16px" }}>
                  People to follow
                </h5>
                <div>
                  <button>
        ...
        >
          <section id="modal-card">
            ...
            >
              ...
              <button
                className="max-w-max flex-center followers-close-button"
            ...
            <main className="mt-2">
              {userFollowers === false ? (
                <h2 style={{ textAlign: "center" }}>
                  You can not access to followers
                </h2>
              ) : (
                userFollowers.map((follower) => (
                  <article key={follower._id} className="following-card">
                    ...
                    <div>
                      {mainUserFollowings.some(
                        (user) => user._id === follower._id,
                      ) ? (
                        <button
                          className="follow-button text-xs"
                          onClick={(e) => unFollowUserHandler(e, follower._id)}
                        >
                          Unfollow
                        </button>
                        ...
                        <button
                          className="follow-button text-xs"
                          onClick={(e) => followUserHandler(e, follower._id)}
                        >
                          Follow
                        </button>
                      )}
        ...
        >
          <section id="modal-card">
            ...
            >
              ...
              <button
                className="max-w-max flex-center followings-close-button"
            ...
            <main className="mt-2">
              {userFollowings === false ? (
                <h2 style={{ textAlign: "center" }}>
                  You can not access to followings
                </h2>
              ) : (
                  ...
                  <article key={following._id} className="following-card">
                    ...
                    <div>
                      {mainUserFollowings.some(
                        ...
                        <button
                          className="follow-button text-xs"
                          onClick={(e) => unFollowUserHandler(e, following._id)}
                        >
                          Unfollow
                        </button>
                        ...
                        <button
                          className="follow-button text-xs"
                          onClick={(e) => followUserHandler(e, following._id)}
                        >
                          Follow
                        </button>
                      )}
